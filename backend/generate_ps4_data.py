"""
Enterprise Data Generator for Insider Threat Detection
Generates 100 users, 1500 logs with ~150 injected threat scenarios
"""
...
def generate_profiles(num_users=100):
    """Generate realistic user profiles with varied access patterns."""
    ...
    for i in range(1, num_users + 1):
        ...
        profiles.append({
            ...
            'high_risk_flag': random.random() < 0.05,  # 5% are flight risks
...
def generate_logs(profiles_df, num_events=1500, anomaly_rate=0.10):
    """Generate realistic access logs with injected threat scenarios."""
